...
def playerconsistof():
	file = open('player_consist_of.txt', 'w')
	out = []
	j = 0
	pos = [1, 2, 3, 4, 5]
...
def pick():
	file = open('pick.txt', 'w')
	read = open('play_in.txt', 'r')
	out = []
